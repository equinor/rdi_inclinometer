...
class InclinometerManager(object):
    ...
    def getMeasurements(self):
        ...
        print("Cleared acceleration_data(%s), angular_data(%s) & magnetic_data(%s)" % (str(self.accelerometer_data), str(self.angular_data), str(self.magnetic_data)))
        ...
        print(">>> Get measurement - time_delta: %.4f seconds" % (time_delta))
        return self.accelerometer_data, self.angular_data, self.magnetic_data
